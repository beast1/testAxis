...
function createSelect() {
    ...
    function wrapElement(el, wrapper, i) {
        ...
        var buttonElement = document.createElement("button"),
            ...
            spanText = document.createTextNode("3");
...
var openCartBtns = document.querySelectorAll('.js-buy');
var closeCartBtns = cartWindow.querySelectorAll('.cart__empty-space, .cart__title');
openCartBtns.forEach(function (openCartBtn) {
    openCartBtn.addEventListener('click', function(e) {
        e.preventDefault();
        cartWindow.classList.add('cart_visible');
    });
});
...
closeCartBtns.forEach(function (closeCartBtn) {
    closeCartBtn.addEventListener('click', function(e) {
        e.preventDefault();
        cartWindow.classList.remove('cart_visible');
    });
});
